...
class AdministratorView(Observer):
    def __init__(self, parent=None):
        self.admin_con = AdministratorController(self)
        ...
        self.filter_user_var = tk.StringVar(value='Filter Users')
        filter_user_menu = ttk.OptionMenu(self.buttons_frame, self.filter_user_var, 'Filter Users', 'admin', 'employee',
                                          command=self.filter_users_by_type)
        filter_user_menu.pack(side=tk.LEFT, padx=10, pady=10)

        self.language_var = tk.StringVar(value=self.language)
        language_menu = ttk.OptionMenu(self.root, self.language_var, self.language, *languages.keys(),
                                       command=lambda lang: self.admin_con.change_language(lang))
        language_menu.pack(side=tk.TOP, anchor=tk.E)


        self.display_packages_button = tk.Button(self.buttons_frame, text="View Packages",
                                                 command=self.admin_con.display_sorted_packages_by_destination_and_period,
        ...
        self.display_users_button = tk.Button(self.buttons_frame, text="View Users",
                                              command=self.admin_con.display_users,
                                              bg="white", fg="black", font=("Arial", 10, "bold"))
        ...
        self.model_package.add_observer(self.admin_con)
        self.model_users.add_observer(self)
        self.model_users.add_observer(self.admin_con)
        ...
        self.delete_user_button = tk.Button(self.crud_user_frame, text="Delete User",
                                            command=self.admin_con.delete_selected_user, bg="darkblue",
    ...
    def select_destination(self, event):
        ...
        self.model_package.package_repo.search_packages_by_destination(selected_destination)
    ...
    def select_price(self, event):
        ...
        self.model_package.package_repo.search_packages_by_price(min_price, max_price)
    ...
    def select_by_date(self, event):
        ...
        self.admin_con.search_packages_by_dates(selected_start_date, selected_end_date)
    ...
    def submit_user(self):
        ...
        self.admin_con.add_user(user_id, username, password, type)
    ...
    def open_update_user_window(self):
        ...
        package_ids = [package.UserId for package in
                       self.model_users.user_repo.get_all_users()]
    ...
    def update_user(self):
        ...
        self.admin_con.update_user(selected_user_id, new_field_dict)
    ...
    def filter_users_by_type(self, user_type):
        self.admin_con.filter_users_by_type(user_type)
    ...
    def change_language(self):
        ...
        self.display_users_button.config(text=languages[lang]['view_users'])
        self.add_user_button.config(text=languages[lang]['add_user'])
        self.update_user_button.config(text=languages[lang]['update_user'])
        self.delete_user_button.config(text=languages[lang]['delete_user'])
